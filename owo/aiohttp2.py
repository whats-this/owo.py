# This here is purely to override aiohttp's quoting system because it's shit and PR #916 has been open for about a year
...
class BodyPartWriter(aiohttp.BodyPartWriter):
    def set_content_disposition(self, disposition_type, should_quote=True, **params):
        ...
        if params:
            ...
            value = '; '.join((value, '; '.join('='.join(pair) for pair in lparams)))
